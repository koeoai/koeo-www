...
- [ ] 2. Add Sample UI label to product page
  - [ ] 2.1 Update product page component with Sample UI label
    - Add visible "Sample UI" label near console metrics display
    - Position label clearly to indicate metrics are illustrative
    - _Requirements: 3.1, 3.2_
  - [ ] 2.2 Write unit test for Sample UI label
    - Verify label renders on product page
    - _Requirements: 3.1_

- [ ] 3. Soften compliance claim on providers page
  - [ ] 3.1 Update English providers content
...
- [ ] 4. Fix French localization gaps
  ...
  - [ ] 4.2 Localize request flow animation component
    ...
    - _Requirements: 5.2_
  - [ ] 4.3 Update French product content for tone consistency
    - Ensure "vous" form is used consistently
    - _Requirements: 5.4_
  - [ ] 4.4 Update French providers content for tone consistency
    - Shift from "tu" form to "vous" form
    - Update compliance claim to match English
    - _Requirements: 5.4, 4.2_
  - [ ] 4.5 Verify French about page has no English in hero
    - Check and fix any English strings in French about content
    - _Requirements: 5.3_
  - [ ] 4.6 Write property test for French localization completeness
    - **Property 2: French Localization Completeness**
    - Verify no English UI strings in French content
    - **Validates: Requirements 5.1, 5.2, 5.3**
  - [ ] 4.7 Write property test for French tone consistency
    - **Property 3: French Tone Consistency**
    - Verify "vous" form used consistently, not "tu" form
    - **Validates: Requirements 5.4**

- [ ] 5. Add fourth persona for labs/universities
  - [ ] 5.1 Add Research Labs persona to English product content
  ...
  - [ ] 5.2 Add Research Labs persona to French product content
    - Translate fourth persona card to French
    - _Requirements: 6.1, 6.2_
  - [ ] 5.3 Write unit test for persona count
    - Verify product page has exactly 4 personas
    - _Requirements: 6.1_

- [ ] 6. Add trust signal to homepage
